...
{
    public PlayerWalkState(Player player, PlayerStateMachine playerStateMachine, float baseSpeed, float speedMultiplier) : base(player, playerStateMachine, baseSpeed, speedMultiplier)
    {
    }
    ...
    public override void FrameUpdate()
    {
        ...
        {           
            ...
            Debug.Log("Estás andando" + " " + baseSpeed * speedMultiplier);
        }
        else
        {
