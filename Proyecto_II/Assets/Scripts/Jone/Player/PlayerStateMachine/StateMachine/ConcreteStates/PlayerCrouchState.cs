...
{
    public PlayerCrouchState(Player player, PlayerStateMachine playerStateMachine, float baseSpeed, float speedMultiplier) : base(player, playerStateMachine, baseSpeed, speedMultiplier)
    {
    }
    ...
    public override void EnterState()
    {
        ...
        Debug.Log("Estás andando agachado" + " " + baseSpeed * speedMultiplier);
    }
    ...
    public override void FrameUpdate()
    {
        ...
        if (!player.crouchedAction.action.IsPressed())
        {
