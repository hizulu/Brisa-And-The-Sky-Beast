 ...
 * FECHA: 09/03/2025
 * DESCRIPCI”N: Clase que hereda de IState
 * VERSI”N: 1.0.
 */
...
>>>>>>> parent of d4eaec9 (Prueba de interacci√≥n Bestia con panel y EventsManager)
    ...
    public void Rotate(Vector3 movementDirection)
    {
        ...
        {
            Quaternion targetRotation = Quaternion.LookRotation(movementDirection); // Hace que el personaje gire en la direcciÛn donde se produce el movimiento.
